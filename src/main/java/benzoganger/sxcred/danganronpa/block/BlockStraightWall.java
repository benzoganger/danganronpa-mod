...
public class BlockStraightWall extends ElementsDanganronpaModMod.ModElement {
	@GameRegistry.ObjectHolder("danganronpa_mod:straight_wall")
	public static final Block block = null;
	public BlockStraightWall(ElementsDanganronpaModMod instance) {
		super(instance, 10);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("danganronpa_mod:straight_wall", "inventory"));
	}
